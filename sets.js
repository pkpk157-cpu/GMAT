...
window.GMAT_SETS = [
  ...
  {
    "id": "cr-set3",
    "title": "Critical Reasoning \u2014 Set 3",
    "section": "cr",
    "source": "CR practice: paradox, weaken, strengthen & flaw (with answer key & solutions)",
    "questions": [
      {"topic": "Explain the paradox", "correct": "E", "options": 5, "text": "Which of the following most logically completes the passage? Concerned about financial well-being of its elderly citizens, the government of Runagia decided two years ago to increase by 20 percent the government-provided pension paid to all Runagians over 65. Inflation in the intervening period has been negligible, and the increase has been duly received by all eligible Runagians. Nevertheless, many of them are no better off financially than they were before the increase, in large part because .", "choices": ["They rely entirely on the government pension for their income", "Runagian banks are so inefficient that it can take up to three weeks to cash a pension check", "They buy goods whose prices tend to rise especially fast in times of inflation", "The pension was increased when the number of elderly Runagians below the poverty level reached an all-time high", "In Runagia children typically supplement the income of elderly parents, but only by enough to provide them with a comfortable living"], "hint": "Find a new fact that lets both surprising facts be true at once.", "expl": "Correct answer: E. Summary: The government increased all the elderly people's pensions but, for some reason, the elderly people don't actually have any more money now. Our challenge is to find the \"some reason\" here. We need a reason why the increase will have NO EFFECT on the elderly people's income.", "level": "medium", "n": 1},
      {"topic": "Explain the paradox", "correct": "E", "options": 5, "text": "Which of the following, if true, most logically completes the passage? A recent poll found that almost all residents of Nalmed Province favored a massive expansion of the commuter rail system as a means of significantly easing congestion on the province's highways and were willing to help pay for the expansion through an increase in their taxes. Nevertheless, the poll results indicate that expansion of the rail system, if successfully completed, would be unlikely to achieve its goal of easing congestion, because .", "choices": ["the proposed expansion to the commuter rail system will make it possible for some people who both live and work at suburban locations to commute by rail", "of the less than 20 percent of residents not counted as favoring the expansion, about half claimed to have no opinion one way or the other", "the twice-daily periods of peak congestion caused by people commuting in cars have grown from about an hour each to almost two and a half hours each in the past 20 years", "expanding the commuter rail system will require the construction of dozens of miles of new railbed", "all people in favor of expanding the rail system reported less congestion during their highway commute as the primary benefit that they will experience once the expansion of the railway network is complete"], "hint": "Find a new fact that lets both surprising facts be true at once.", "expl": "Correct answer: E. E. CORRECT. This indicates that all people taking the survey plan to use the highway even after the railways are expanded. Therefore, if all these people continued to drive to work, the congestion on the highway won't ease despite the expansion of the railways.", "level": "medium", "n": 2},
      {"topic": "Explain the paradox", "correct": "E", "options": 5, "text": "In order to raise revenue, the federal government planned a tax amnesty program that allows tax delinquents to pay all owed tax without added financial penalty. However, economists projected that the federal government would collect a far lower percentage of total tax owed by delinquents than did state governments that implement similar programs. Which of the following, if true, would most contribute to an explanation of the economists' projections?", "choices": ["Tax amnesty programs are only successful if they are widely publicized.", "Most people who honestly pay their state tax are equally honest in paying their federal tax.", "Although federal tax delinquents usually must pay high financial penalties, the states require far lower financial penalties.", "The state tax rate varies considerably from state to state, but the federal tax is levied according to laws which apply to citizens of all the states.", "Unlike most federal tax delinquents, most state tax delinquents fail to pay state tax because of an oversight rather than a decision not to pay."], "hint": "Find a new fact that lets both surprising facts be true at once.", "expl": "Correct answer: E. Summary: Fact 1: Federal government implemented a tax amnesty program. Fact 2: Tax amnesty program allows tax delinquents to pay all owed tax without added financial penalty. Prediction: This program will not be as effective for the federal government as it was for the state government. We need an option that supports this prediction: A.", "level": "medium", "n": 3},
      {"topic": "Explain the paradox", "correct": "C", "options": 5, "text": "For several years, per capita expenditure on prescription drugs in Voronia rose by fifteen percent or more annually. In order to curb these dramatic increases, the ministry of health prohibited drug manufacturers from raising any of their existing products' prices. Even though use of prescription drugs did not expand after this price freeze, per capita expenditure for prescription drugs continued to increase by a substantial percentage each year. Which of the following, if true, most helps to explain why the ministry's action did not achieve its goal?", "choices": ["The population of Voronia rose steadily throughout the period.", "Improvements in manufacturing processes enabled drug manufacturers to maintain high profit levels on drugs despite the price freeze.", "After price increases were prohibited, drug manufacturers changed the brand names and labels of most of their existing prescription drug products.", "In addition to imposing a price freeze, the government encouraged doctors to prescribe generic versions of common drugs instead of the more expensive brand- name versions.", "After price increases were prohibited, some foreign manufacturers of expensive drugs ceased marketing them in Voronia."], "hint": "Find a new fact that lets both surprising facts be true at once.", "expl": "Correct answer: C. If we introduce a new product at a very high price, we can't be accused of \"increasing\" the price … increase happens on an existing price. \"Per-capita expenditure\" is the total price paid for drugs (price per pill * # of pills) divided by the number of people.", "level": "medium", "n": 4},
      {"topic": "Explain the paradox", "correct": "D", "options": 5, "text": "In Rubaria, excellent health care is available to virtually the entire population, whereas very few people in Terland receive adequate medical care. Yet, although the death rate for most diseases is higher in Terland than in Rubaria, the percentage of the male population that dies from prostate cancer is significantly higher in Rubaria than in Terland. Which of the following, if true, most helps to explain the disparity between the prostate cancer death rate in Rubaria and Terland?", "choices": ["Effective treatment of prostate cancer in its early stages generally requires medical techniques available in Rubaria but not in Terland.", "Being in poor general health does not increase one's risk of developing prostate cancer.", "It is possible to decrease one's risk of getting prostate cancer by eating certain kinds of foods, and such foods are more readily available in Rubaria than in Terland.", "All men who have prostate cancer around the world are older than the life expectancy for male inhabitants of Terland, whereas men live to a ripe old age in Rubaria owing to Rubaria's excellent healthcare system.", "Among men in Rubaria, the death rate from prostate cancer is significantly higher for those who do not take full advantage of Rubaria's health care system than for those who do."], "hint": "Find a new fact that lets both surprising facts be true at once.", "expl": "Correct answer: D. This problem is an exact analogue of the real-world situation with such maladies as heart disease and breast/prostate cancer, which generally strike older individuals. There are often strikingly low rates of death from those maladies in countries with otherwise horrible public health (such as sub- Saharan African countries).", "level": "medium", "n": 5},
      {"topic": "Explain the paradox", "correct": "E", "options": 5, "text": "The cotton farms of Country Q became so productive that the market could not absorb all that they produced. Consequently, cotton prices fell. The government tried to boost cotton prices by offering farmers who took 25 percent of their cotton acreage out of production direct support payments up to a specified maximum per farm. The government's program, if successful, will not be a net burden on the budget. Which of the following, if true, is the best basis for an explanation of how this could be so?", "choices": ["Cotton production in several counties other than Q declined slightly the year that the support- payment program went into effect in Q.", "The first year that the support-payment program was in effect, cotton acreage in Q was 5% below its level in the base year for the program.", "The specified maximum per farm meant that for very large cotton farms the support payments were less per acre for those acres that were withdrawn from production than they were for smaller farms.", "Farmers who wished to qualify for support payments could not use the cotton acreage that was withdrawn from production to grow any other crop.", "Depressed cotton prices meant operating losses for cotton farms, and the government lost revenue from taxes on farm profits, but by introducing the new plan, the government hopes that prices will go up again and, thus enabling the government to collect more taxes than it currently collects."], "hint": "Find a new fact that lets both surprising facts be true at once.", "expl": "Correct answer: E. CORRECT option: E The government is giving away money (negative budget) to farmers who take 25% of their farms‟ acreage out of cotton. If the farmers have operating losses as of now, they are likely to have a lower income and hence they would pay less tax to the government (negative budget).", "level": "medium", "n": 6},
      {"topic": "Explain the paradox", "correct": "E", "options": 5, "text": "Finding of a survey of Systems magazine subscribers: Thirty percent of all merchandise orders placed by subscribers in response to advertisements in the magazine last year were placed by subscribers under age thirty-five. Finding of a survey of advertisers in Systems magazine: Most of the merchandise orders placed in response to advertisements in Systems last year were placed by people under age thirty-five. For both of the findings to be accurate, which of the following must be true?", "choices": ["More subscribers to Systems who have never ordered merchandise in response to advertisements in the magazine are age thirty-five or over than are under age thirty- five.", "Among subscribers to Systems, the proportion who are under age thirty-five was considerably lower last year than it is now.", "Most merchandise orders placed in response to advertisements in Systems last year were placed by Systems subscribers over age thirty-five.", "Last year, the average dollar amount of merchandise orders placed was less for subscribers under age thirty-five than for those aged thirty-five or over.", "Last year many people who placed orders for merchandise in response to advertisements in Systems were not subscribers to the magazine."], "hint": "Find a new fact that lets both surprising facts be true at once.", "expl": "Correct answer: E. The number of orders placed = those by subscribers + those by nonsubscribers If say 100 subscribers placed orders and 30 of them were below thirty-five. If there were 1000 nonsubscribers who placed orders, out of whom 900 were below thirty-five, we can reason thus: The total orders placed = 1100 and out of them 930 are from people below thirty-five.", "level": "medium", "n": 7},
      {"topic": "Explain the paradox", "correct": "D", "options": 5, "text": "Because dinosaurs were reptiles, scientists once assumed that, like all reptiles alive today, dinosaurs were cold-blooded. The recent discovery of dinosaur fossils in the northern arctic, however, has led a number of researchers to conclude that at least some dinosaurs might have been warm-blooded. These researchers point out that only warm-blooded animals could have withstood the frigid temperatures that are characteristic of arctic winters, whereas cold-blooded animals would have frozen to death in the extreme cold. Which one of the following, if true, weakens the researchers' argument?", "choices": ["Today's reptiles are generally confined to regions of temperate or even tropical climates.", "The fossils show the arctic dinosaurs to have been substantially smaller than other known species of dinosaurs.", "The arctic dinosaur fossils were found alongside fossils of plants known for their ability to withstand extremely cold temperatures.", "The number of fossils found together indicates herds of dinosaurs so large that they would need to migrate to find a continual food supply.", "Experts on prehistoric climatic conditions believe that winter temperatures in the prehistoric northern arctic were not significantly different from what they are today."], "hint": "Find a new fact that lets both surprising facts be true at once.", "expl": "Correct answer: D. Dinosaur fossils in northern arctic + Only warm-blooded animals can withstand arctic winters -> Some dinosaurs were warm-blooded. What are the gaps in this argument? For one, perhaps the winters may have been different when the dinosaurs were around.", "level": "medium", "n": 8},
      {"topic": "Weaken", "correct": "D", "options": 5, "text": "There is relatively little room for growth in the overall carpet market, which is tied to the size of the population. Most who purchase carpet do so only once or twice, first in their twenties or thirties, and then perhaps again in their fifties or sixties. Thus, as the population ages, companies producing carpet will be able to gain market share in the carpet market only through purchasing competitors, and not through more aggressive marketing. Which one of the following, if true, casts the most doubt on the conclusion above?", "choices": ["Two of the three mergers in the industry's last ten years led to a decline in profits and revenues for the newly merged companies.", "Most of the major carpet producers market other floor coverings as well.", "Most established carpet producers market several different brand names and varieties, and there is no remaining niche in the market for new brands to fill.", "Price reductions, achieved by cost-cutting in production, by some of the dominant firms in the carpet market are causing other producers to leave the market altogether.", "The carpet market is unlike most markets in that consumers are becoming increasingly resistant to new patterns and styles."], "hint": "Attack the link between evidence and conclusion - look for an overlooked alternative.", "expl": "Correct answer: D. The key to success is to isolate the conclusion, which appears in the last sentence: \"companies producing carpet will be able to gain market share in the carpet market only through purchasing competitors.\" Answer choice (A) is about a decline in profits (nothing to do with the market share) and revenues (market share is about percentage … not absolute revenu", "level": "medium", "n": 9},
      {"topic": "Weaken", "correct": "C", "options": 5, "text": "In the United States, of the people who moved from one state to another when they retired, the percentage who retired to Florida has decreased by three percentage points over the past ten years. Since many local businesses in Florida cater to retirees, these declines are likely to have a noticeably negative economic effect on these businesses and therefore on the economy of Florida. Which of the following, if true, most seriously weakens the argument given?", "choices": ["People who moved from one state to another when they retired moved a greater distance, on average, last year than such people did ten years ago.", "People were more likely to retire to North Carolina from another state last year than people were ten years ago.", "The number of people who moved from one state to another when they retired has increased significantly over the past ten years.", "The number of people who left Florida when they retired to live in another state was greater last year than it was ten years ago.", "Florida attracts more people who move from one state to another when they retire than does any other state."], "hint": "Attack the link between evidence and conclusion - look for an overlooked alternative.", "expl": "Correct answer: C. A. Distance is irrelevant. B. We are concerned specifically with the number of retirees moving to Florida. C. CORRECT Assume that last year 1000 people retired and moved to another state. Out of these 1000 people, 100 of them move to Florida. That means, 10% of the people moved to Florida. This year, the % of the people moved to Florida decreased by 3%.", "level": "medium", "n": 10},
      {"topic": "Weaken", "correct": "C", "options": 5, "text": "In the past, most children who went sledding in the winter snow in Verland used wooden sleds with runners and steering bars. Ten years ago, smooth plastic sleds became popular; they go faster than wooden sleds but are harder to steer and slow. The concern that plastic sleds are more dangerous is clearly borne out by the fact that the number of children injured while sledding was much higher last winter than it was ten years ago. Which of the following, if true in Verland, most seriously undermines the force of the evidence cited?", "choices": ["A few children still use traditional wooden sleds.", "Very few children wear any kind of protective gear, such as helmets, while sledding.", "Plastic sleds can be used in a much wider variety of snow conditions than wooden sleds can.", "Most sledding injuries occur when a sled collides with a tree, a rock, or another sled.", "Because the traditional wooden sled can carry more than one rider, an accident involving a wooden sled can result in several children being injured."], "hint": "Attack the link between evidence and conclusion - look for an overlooked alternative.", "expl": "Correct answer: C. The passage connects an increased NUMBER of injuries with a contention that the plastic sleds are MORE LIKELY to cause injuries (i.e., that the plastic sleds cause a higher RATE / FREQUENCY of injuries).", "level": "medium", "n": 11},
      {"topic": "Weaken", "correct": "B", "options": 5, "text": "Twelve years ago, and again five years ago, there were extended periods when Darfir Republic's currency, the pundra, was weak: its value was unusually low relative to the world's most stable currencies. Both times a weak pundra made Darfir's manufactured products a bargain on the world markets, and Darfir's exports were up substantially. Now some politicians are saying that, in order to cause another similarly sized increase in exports, the government should allow the pundra to become weak again. Which of the following if true provides the government with the strongest grounds to doubt the politician's recommendation, if followed, will achieve its aim?", "choices": ["several of the politicians no recommending that the pundra be allowed to become weak made that same recommendation before each of the last two periods of currency weakness.", "after several decades of operating well below its peak capacity, Darfir's manufacturing sector is now operating at near-peak levels", "the economy of a country experiencing a rise in exports will become healthier only if the country's currency is strong or the rise in exports is significant.", "those countries whose manufactured products compete with Darfir's on the world market currently all have stable currencies", "a sharp improvement in the efficiency of Darfir's manufacturing plants would make Darfir's products a bargain on the world markets even without weakening of the pundra relative to other currencies."], "hint": "Attack the link between evidence and conclusion - look for an overlooked alternative.", "expl": "Correct answer: B. \"Which of the following, if true, provides the government with the strongest grounds to doubt that the politicians' recommendation, if followed, will achieve its aim?\" Answer choice E does not address \"if followed\". E says, essentially: there is a better way to achieve the goal of increasing exports.", "level": "medium", "n": 12},
      {"topic": "Weaken", "correct": "E", "options": 5, "text": "Kernland imposes a high tariff on the export of unprocessed cashew nuts in order to ensure that the nuts are sold to domestic processing plants. If the tariff were lifted and unprocessed cashews were sold at world market prices, more farmers could profit by growing cashews. However, since all the processing plants are in urban areas, removing the tariff would seriously hamper the government's effort to reduce urban unemployment rate over the next five years. Which of the following, if true, most seriously weakens the argument?", "choices": ["Some of the byproducts of processing cashews are used for manufacturing paints and plastics.", "Other countries in which cashews are processed subsidize their processing plants.", "More people in Kernland are engaged in farming cashews than in processing them.", "Buying unprocessed cashews at lower than world market prices enables cashew processors in Kernland to sell processed nuts at competitive prices", "A lack of profitable crops is driving an increasing number of small farmers in Kernland off their land and into the cities."], "hint": "Attack the link between evidence and conclusion - look for an overlooked alternative.", "expl": "Correct answer: E. E is right because it shows us that without good crops to grow for profit, poor farmers move to the city. Well, the tariff, if removed, would allow those poor farmers to make money growing cashews (and maybe they will come back from the cities - where they were working in the domestic processing plants - and will start growing the profitable crop).", "level": "medium", "n": 13},
      {"topic": "Weaken", "correct": "A", "options": 5, "text": "Several companies will soon offer personalized electronic news services, delivered via cable or telephone lines and displayed on a television. People using these services can view continually updated stories on those topics for which they subscribe. Since these services will provide people with the information they are looking for more quickly and efficiently than printed newspapers can, newspaper sales will decline drastically if these services become widely available. Which one of the following, if true, most seriously weakens the argument?", "choices": ["In reading newspapers, most people not only look for stories on specific topics but also like to idly browse through headlines or pictures for amusing stories on unfamiliar or unusual topics.", "Companies offering personalized electronic news services will differ greatly in what they charge for access to their services, depending on how wide a range of topics they cover.", "Approximately 30 percent of people have never relied on newspapers for information but instead have always relied on news programs broadcast on television and radio.", "The average monthly cost of subscribing to several channels on a personalized electronic news service will approximately equal the cost of a month's subscription to a newspaper.", "Most people who subscribe to personalized electronic news services will not have to pay extra costs for installation since the services will use connections installed by cable and telephone companies."], "hint": "Attack the link between evidence and conclusion - look for an overlooked alternative.", "expl": "Correct answer: A. These (electronic news) services will provide people with the information they are looking for more quickly and efficiently than printed newspapers can -> newspaper sales will decline drastically if these services become widely available. Do people primarily read newspapers searching for stuff they already know about? No.", "level": "medium", "n": 14},
      {"topic": "Weaken", "correct": "B", "options": 5, "text": "Navigation in animals is defined as the animal's ability to find its way from unfamiliar territory to points familiar to the animal but beyond the immediate range of the animal's senses. Some naturalists claim that polar bears can navigate over considerable distances. As evidence, they cite an instance of a polar bear that returned to its home territory after being released over 500 kilometers (300 miles) away. Which one of the following, if true, casts the most doubt on the validity of the evidence offered in support of the naturalists' claim?", "choices": ["The polar bear stopped and changed course several times as it moved toward its home territory.", "The site at which the polar bear was released was on the bear's annual migration route.", "The route along which the polar bear traveled consisted primarily of snow and drifting ice.", "Polar bears are only one of many species of mammal whose members have been known to find their way home from considerable distances.", "Polar bears often rely on their extreme sensitivity to smell in order to scent out familiar territory."], "hint": "Attack the link between evidence and conclusion - look for an overlooked alternative.", "expl": "Correct answer: B. (B) is correct. First of all, to fit the definition of navigation, the animal must find its way from unfamiliar territory to familiar territory beyond the range of its senses. Next, a polar bear returned home after being released 300 miles away. (A) ... so what? Nothing in the given definition of navigation says that changing direction is not allowed.", "level": "medium", "n": 15},
      {"topic": "Weaken", "correct": "B", "options": 5, "text": "Tiger beetles are such fast runners that they can capture virtually any nonflying insect. However, when running toward an insect, a tiger beetle will intermittently stop and then, a moment later, resume its attack. Perhaps the beetles cannot maintain their pace and must pause for a moment's rest; but an alternative hypothesis is that while running, tiger beetles are unable to adequately process the resulting rapidly changing visual information and so quickly go blind and stop. Which of the following, if discovered in experiments using artificially moved prey insects, would support one of the two hypotheses and undermine the other?", "choices": ["When a prey insect is moved directly toward a beetle that has been chasing it, the beetle immediately stops and runs away without its usual intermittent stopping.", "In pursuing a swerving insect, a beetle alters its course while running and its pauses become more frequent as the chase progresses.", "In pursuing a moving insect, a beetle usually responds immediately to changes in the insect's direction, and it pauses equally frequently whether the chase is up or down an incline.", "If, when a beetle pauses, it has not gained on the insect it is pursuing, the beetle generally ends its pursuit.", "The faster a beetle pursues an insect fleeing directly away from it, the more frequently the beetle stops."], "hint": "Attack the link between evidence and conclusion - look for an overlooked alternative.", "expl": "Correct answer: B. The keywords here are: rapidly changing visual information … The word \"move / moving\" does not guarantee rapidly changing visual information. An insect can move at the rate of 1 inch per hour as well. So, A and C can be eliminated.", "level": "medium", "n": 16},
      {"topic": "Strengthen", "correct": "B", "options": 5, "text": "During the 1930s, Roosevelt's New Deal expanded federal authority by creating several new government agencies designed to administer financial relief to the country, which had been devastated by the 1929 stock market crash and the ensuing economic depression. In the decades following the depression, however, policymakers grew uncomfortable with the amount of power that had been given to the federal government and sought to discontinue many of the agencies created under the New Deal. Although they feared another economic depression, many prominent economists of that time sided with those policymakers. Which of the following, if true, most strengthens the stance taken by the prominent economists?", "choices": ["further expansion of federal authority would hinder economic growth and increase the risk of another economic depression.", "many agencies created under the New Deal were designed to provide financial relief, not to maintain economic stability.", "most Americans feared expansion of federal authority more than they feared another economic depression.", "the power and authority of many agencies created under the New Deal had expanded well beyond the limits defined in their respective agency charters.", "most policymakers of that time considered federal regulation of the market to be an emergency measure that, as such, should only be temporary."], "hint": "Support the conclusion by confirming its key link or ruling out an alternative.", "expl": "Correct answer: B. The conclusion is that \"many prominent economists of that time sided with those policymakers\", implying that the economists, like the policymakers, \"grew uncomfortable with the amount of power that had been given to the federal government and sought to discontinue many of the agencies created under the New Deal.\" How do we arrive at that conclusion? The agen", "level": "medium", "n": 17},
      {"topic": "Strengthen", "correct": "C", "options": 5, "text": "There should be a greater use of gasohol. Gasohol is a mixture of alcohol and gasoline, and has a higher-octane rating and fewer carbon monoxide emissions than straight gasoline. Burning gasohol adds no more carbon dioxide to the atmosphere than plants remove by photosynthesis. Each of the following, if true, strengthens the argument above EXCEPT:", "choices": ["Cars run less well on gasoline than they do on gasohol.", "Since less gasoline is needed with the use of gasohol, an energy shortage is less likely.", "Cars burn on the average slightly more gasohol per kilometer than they do gasoline.", "Gasohol is cheaper to produce and hence costs less at the pump than gasoline.", "Burning gasoline adds more carbon dioxide to the atmosphere than plants can remove."], "hint": "Support the conclusion by confirming its key link or ruling out an alternative.", "expl": "Correct answer: C. (C) is correct. Here, the author's conclusion is that there should be a greater use of gasohol. The support given is that gasohol is higher in octane and has fewer emissions than gasoline. Also, burning gasohol adds no more carbon to the atmosphere than plants remove.", "level": "medium", "n": 18},
      {"topic": "Strengthen", "correct": "A", "options": 5, "text": "Consumer advocate: The introduction of a new drug into the marketplace should be contingent upon our having a good understanding of its social impact. However, the social impact of the newly marketed antihistamine is far from clear. It is obvious, then, that there should be a general reduction in the pace of bringing to the marketplace new drugs that are now being tested. Which one of the following, if true, most strengthens the argument?", "choices": ["The social impact of the new antihistamine is much better understood than that of most new drugs being tested.", "The social impact of some of the new drugs being tested is poorly understood.", "The economic success of some drugs is inversely proportional to how well we understand their social impact.", "The new antihistamine is chemically similar to some of the new drugs being tested.", "The new antihistamine should be on the market only if most new drugs being tested should be on the market also."], "hint": "Support the conclusion by confirming its key link or ruling out an alternative.", "expl": "Correct answer: A. (A) is correct. Here's the core: Introduction of drugs to marketplace should be contingent on understanding social impact + the social impact of a certain antihistamine (one already on the market) is unclear -> there should be a general reduction in the pace of bringing to market new drugs now being tested.", "level": "medium", "n": 19},
      {"topic": "Strengthen", "correct": "B", "options": 5, "text": "In the year following an eight-cent increase in the federal tax on a pack of cigarettes, sales of cigarettes fell ten percent. In contrast, in the year prior to the tax increase, sales had fallen one percent. The volume of cigarette sales is therefore strongly related to the after-tax price of a pack of cigarettes. Which of the following, if true, would most strengthen the argument given?", "choices": ["During the second year after the tax increase, cigarette sales increased by a significant amount.", "The information available to consumers on the health risks of smoking remained largely unchanged in the period before and after the tax increase.", "Most consumers were unaware that the tax on cigarettes was going to increase.", "During the year following the cigarette tax increase, many consumers had less income, in inflation- adjusted dollars, than they had had in the previous year.", "During the year after the tax increase, there was a greater variety of cigarettes on the market than there had been during the previous year. FLAW questions The approach to solving Flaw questions is identical to the approach to solving Weaken questions. The GMAT mainly tests only three types of flaws:"], "hint": "Support the conclusion by confirming its key link or ruling out an alternative.", "expl": "Correct answer: B. Note: this is an absolutely classic type of problem: it CONFLATES CORRELATION WITH CAUSATION. It takes a statistical correlation between cigarette tax and cigarette consumption, and postulates that one has a CAUSAL effect on the other.", "level": "medium", "n": 20},
      {"topic": "Strengthen", "correct": "D", "options": 5, "text": "Some people believe that good health is due to luck. However, studies from many countries indicate a strong correlation between good health and high educational levels It is well known that high educational levels allow people to make more informed lifestyle choices. Thus, research supports the view that good health is largely the result of making informed lifestyle choices. The reasoning in the argument is most vulnerable to criticism on the grounds that the argument", "choices": ["presumes, without providing justification, that only highly educated people make informed lifestyle choices", "overlooks the possibility that people who make informed lifestyle choices may nonetheless suffer from inherited diseases", "presumes, without providing justification, that informed lifestyle choices are available to everyone", "overlooks the possibility that the same thing may causally contribute both to education and to good health", "does not acknowledge that some people who fail to make informed lifestyle choices are in good health"], "hint": "Support the conclusion by confirming its key link or ruling out an alternative.", "expl": "Correct answer: D. Note that the conclusion of the argument is an explicit claim of causation: \"Thus research supports the view that good health is largely the result of making informed lifestyle choices.\" That is, making informed lifestyle choices has a direct impact on good health.", "level": "medium", "n": 21},
      {"topic": "Strengthen", "correct": "C", "options": 5, "text": "Premiums for automobile accident insurance are often higher for red cars than for cars of other colors. To justify these higher charges, insurance companies claim that, overall, a greater percentage of red cars are involved in accidents than are cars of any other color. If this claim is true, then lives could undoubtedly be saved by banning red cars from the roads altogether. The reasoning in the argument is flawed because the argument", "choices": ["accepts without question that insurance companies have the right to charge higher premiums for higher-risk clients", "fails to consider whether red cars cost the same to repair as cars of other colors", "ignores the possibility that drivers who drive recklessly have a preference for red cars", "does not specify precisely what percentage of red cars are involved in accidents", "makes an unsupported assumption that every automobile accident results in some loss of life"], "hint": "Support the conclusion by confirming its key link or ruling out an alternative.", "expl": "Correct answer: C. C is correct. Red color cars have highest likelihood of accident -> Lives could be saved by banning red cars. (1) Is it possible that having a higher likelihood of having an accident impacts whether the car is red? This may seem implausible at first, but it actually makes a lot of sense.", "level": "medium", "n": 22},
      {"topic": "Identify the flaw", "correct": "E", "options": 5, "text": "Restaurant manager: In response to requests from our patrons for vegetarian main dishes, we recently introduced three: an eggplant and zucchini casserole with tomatoes, brown rice with mushrooms, and potatoes baked with cheese. The first two are frequently ordered, but no one orders the potato dish, although it costs less than the other two. Clearly, then, our patrons prefer not to eat potatoes. Which one of the following is an error of reasoning in the restaurant manager's argument?", "choices": ["concluding that two things that occur at the same time have a common cause", "drawing a conclusion that is inconsistent with one premise of the argument", "ignoring possible differences between what people say they want and what they actually choose", "attempting to prove a claim on the basis of evidence that a number of people hold that claim to be true", "treating one of several plausible explanations of a phenomenon as the only possible explanation"], "hint": "Name the reasoning error - often a number/percentage, cause-effect, or scope gap.", "expl": "Correct answer: E. We can think of the argument core as follows: No one orders the potato dish -> Our patrons prefer not to eat potatoes. Did you see a flaw when you read the argument initially? The author concludes that the patrons must not prefer potatoes, and the evidence he presents is that no one orders the potato dish.", "level": "hard", "n": 23},
      {"topic": "Identify the flaw", "correct": "E", "options": 5, "text": "A controversial program rewards prison inmates who behave particularly well in prison by giving them the chance to receive free cosmetic plastic surgery performed by medical students. The program is obviously morally questionable, both in its assumptions about what inmates might want and in its use of the prison population to train future surgeons. Putting these moral issues aside, however, the surgery clearly has a powerful rehabilitative effect, as is shown by the fact that, among recipients of the surgery, the proportion who are convicted of new crimes committed after release is only half that for the prison population as a whole. A flaw in the reasoning of the passage is that it", "choices": ["allows moral issues to be a consideration in presenting evidence about matters of fact", "dismisses moral considerations on the grounds that only matters of fact are relevant", "labels the program as \"controversial\" instead of discussing the issues that give rise to controversy", "asserts that the rehabilitation of criminals is not a moral issue", "relies on evidence drawn from a sample that there is reason to believe is unrepresentative"], "hint": "Name the reasoning error - often a number/percentage, cause-effect, or scope gap.", "expl": "Correct answer: E. (E) is correct. The conclusion that the surgery has \"a powerful rehabilitative effect\" contains a word that lets us know the author is asserting a causal relationship -\"effect.\" Does surgery truly cause lower rates of recidivism? Let's go to our checklist.", "level": "hard", "n": 24},
      {"topic": "Identify the flaw", "correct": "D", "options": 5, "text": "The violent crime rate (number of violent crimes per 1,000 residents) in Meadowbrook is 60 percent higher now than it was four years ago. The corresponding increase for Parkdale is only 10 percent. These figures support the conclusion that residents of Meadowbrook are more likely to become victims of violent crime than are residents of Parkdale. The argument above is flawed because it fails to take into account", "choices": ["changes in the population density of both Parkdale and Meadowbrook over the past four years", "how the rate of population growth in Meadowbrook over the past four years compares to the corresponding rate for Parkdale", "the ratio of violent to nonviolent crimes committed during the past four years in Meadowbrook and Parkdale", "the violent crime rates in Meadowbrook and Parkdale four years ago", "how Meadowbrook's expenditures for crime prevention over the past four years compare to Parkdale's expenditures"], "hint": "Name the reasoning error - often a number/percentage, cause-effect, or scope gap.", "expl": "Correct answer: D. Crime Rate at Meadowbrook → 60% higher than 4 years ago Crime Rate at Parkdale → 10% higher than 4 years ago. The argument concludes that people of Meadowbrook are more likely to become victims due to 60% increase. This obviously fails to take into account the initial rate of crime 4 years ago.", "level": "hard", "n": 25}
    ]
  },
  {
    "id": "cr-set4",
    "title": "Critical Reasoning \u2014 Set 4",
    "section": "cr",
    "source": "CR practice: evaluate & assumption (with answer key & solutions)",
    "questions": [
      {"topic": "Evaluate the argument", "correct": "E", "options": 5, "text": "Profits for one of Company X's flagship products have been declining slowly for several years. The CFO investigated and determined that inflation has raised the cost of producing the product but consumers who were surveyed reported that they weren't willing to pay more than the current price. As a result, the CFO recommended that the company stop producing this product because the CEO only wants products whose profit margins are increasing. The answer to which of the following questions would be most useful in evaluating whether the CFO's decision to divest the company of its flagship product is warranted?", "choices": ["Does the company have new and profitable products available with which to replace the flagship product?", "What percentage of Company X's revenues is represented by sales of the flagship product in question?", "Are there additional features which could be added to the product and for which consumers might be willing to pay a higher price?", "Will the rest of Company X's management team agree with the CFO's recommendation?", "Is there a way to reduce the cost to produce the flagship product?"], "hint": "Extremes test: the right question's two answers push the argument opposite ways.", "expl": "Correct answer: E. Profits for a particular product have been going down and the CFO has determined that this is because, on the one hand, the cost to make the product has increased and, on the other, consumers won't pay more than the current price (recall that Profit = Revenues - Costs).", "level": "hard", "n": 1},
      {"topic": "Evaluate the argument", "correct": "E", "options": 5, "text": "Columnist: George Orwell's book 1984 seems to have exercised a lot of influence on many intellectuals. Ten thousand readers of the most intellectually stimulating national daily were surveyed and asked to name that specific one book that had had the most influence on their lives. The maximum number of respondents chose the Bible; 1984 was chosen by the second highest number of respondents. The answer to which one of the following questions would most help in evaluating the argument above?", "choices": ["How many of those surveyed had actually read the books they chose?", "How many books had each person surveyed read?", "Did people speak the truth while answering the survey question?", "Overall, how many book titles were nominated by these 10000 people?", "How many people chose 1984?"], "hint": "Extremes test: the right question's two answers push the argument opposite ways.", "expl": "Correct answer: E. The correct answer choice is (E). The conclusion of the argument is the first sentence: George Orwell's book 1984 seems to have exercised a lot of influence on many intellectuals. The basis for this conclusion is that 1984 was the second most named book in a survey about influential books.", "level": "hard", "n": 2},
      {"topic": "Evaluate the argument", "correct": "D", "options": 5, "text": "Though sucking zinc lozenges has been promoted as a treatment for the common cold, research has revealed no consistent effect. Recently, however, a zinc gel applied nasally has been shown to greatly reduce the duration of colds. Since the gel contains zinc in the same form and concentration as the lozenges, the greater effectiveness of the gel must be due to the fact that cold viruses tend to concentrate in the nose, not the mouth. In order to evaluate the argument, it would be most helpful to determine which of the following?", "choices": ["Whether zinc is effective only against colds, or also has an effect on other virally caused diseases", "Whether there are other herbal remedies that do not contain zinc but that, when taken orally, can reduce the duration of colds", "Whether people who frequently catch colds have a zinc deficiency", "Whether either the zinc gel or the lozenges contain ingredients that have an impact on the activity of the zinc", "Whether the zinc gel has an effect on the severity of cold symptoms, as well as on their duration"], "hint": "Extremes test: the right question's two answers push the argument opposite ways.", "expl": "Correct answer: D. We're trying to figure out why the gel is more effective than the lozenge. The author's explanation focuses on where cold viruses congregate. In any argument in which an author is explaining a phenomenon, we should always wonder if there are any other viable explanations.", "level": "hard", "n": 3},
      {"topic": "Evaluate the argument", "correct": "B", "options": 5, "text": "Scientists have determined that an effective way to lower cholesterol is to eat three servings of whole grains every day. Studies have shown that the cholesterol levels of people who did so were significantly lower after six months than were those of people who did not, even though the cholesterol levels of the two groups were the same before the studies began. Clearly, eating whole grains can have an appreciable effect on cholesterol levels. The answer to which of the following questions, if true, would be most useful in evaluating the claim about whole grains above?", "choices": ["Is it realistic to expect people to eat three servings of whole grains per day?", "Were the two groups of people in the study involved in the same exercise program?", "Can the same drop in cholesterol be achieved through medication?", "Did the study continue to track the subjects beyond six months?", "Are most consumers aware of the different between whole grains and processed grains?"], "hint": "Extremes test: the right question's two answers push the argument opposite ways.", "expl": "Correct answer: B. A caused B C didn't cause B strengthens C caused B weakens (A) The passage already shows that it is realistic to have whole grains 3 times a day. (C) We are not trying to find alternatives. (D) Out of context since the study is primarily concerned about lowering cholesterol by eating whole grains. (E) We do not care about awareness. The correct answer is B.", "level": "hard", "n": 4},
      {"topic": "Evaluate the argument", "correct": "C", "options": 5, "text": "In a certain wildlife park, park rangers are able to track the movements of many rhinoceroses because those animals wear radio collars. When, as often happens, a collar slips off, it is put back on. Putting a collar on a rhinoceros involves immobilizing the animal by shooting it with a tranquilizer dart. Female rhinoceroses that have been frequently re-collared have significantly lower fertility rate than un-collared females. Probably, therefore, some substances in the tranquilizer inhibit fertility. In evaluating the argument, it would be most useful to determine which of the following?", "choices": ["Whether there are more collared female rhinoceroses than un-collared female rhinoceroses in the park.", "How the tranquilizer that is used for immobilizing rhinoceroses differs, if at all, from tranquilizers used in working with other large mammals.", "How often park rangers need to use tranquilizer dart to immobilize rhinoceroses for reasons other than attaching radio collars.", "Whether male rhinoceroses in the wild park lose their collar any more often than the park's female rhinoceroses do", "Whether radio collar is the only practical means that park rangers have for tracking the movements of rhinoceroses in the park."], "hint": "Extremes test: the right question's two answers push the argument opposite ways.", "expl": "Correct answer: C. Imagine there are 100 female rhinos: Scenario 1: In this case, the females are NEVER tranquilized for any reason other than re- collaring.", "level": "hard", "n": 5},
      {"topic": "Evaluate the argument", "correct": "A", "options": 5, "text": "Following several years of declining advertising sales, the Greenville Times reorganized its advertising sales force two years ago. Before the reorganization, the sales force was organized geographically, with some sales representatives concentrating on city-center businesses and others concentrating on different outlying regions. The reorganization attempted to increase the sales representatives' knowledge of clients' businesses by having each sales representative deal with only one type of industry or of retailing. After the reorganization, advertising sales increased. In assessing whether the improvement in advertising sales can properly be attributed to the reorganization, it would be helpful to find out each of the following EXCEPT:", "choices": ["Two years ago, what was the figure for Greenville Times' advertising sales?", "Has the circulation of the Greenville Times increased substantially in the last two years?", "Has there been a substantial turnover in personnel in the advertising sales force over the last two years?", "Before the reorganization, had sales representatives found it difficult to keep up with relevant developments in all types of businesses to which they are assigned?", "Has the economy in Greenville and the surrounding regions been growing rapidly over the last two years?"], "hint": "Extremes test: the right question's two answers push the argument opposite ways.", "expl": "Correct answer: A. A. CORRECT. We don't care about the actual value of advertising-sales revenue … all we care about is that it increased … B. If the circulation has increased this could lead attract more advertisers and thereby lead to increased advertisement sales. In this case, the increased sales will not be because of reorganization. Therefore, B is definitely relevant.", "level": "hard", "n": 6},
      {"topic": "Evaluate the argument", "correct": "C", "options": 5, "text": "Community activist: If Morganville wants to keep its central shopping district healthy, it should prevent the opening of a huge SaveAll discount department store on the outskirts of Morganville. Records from other small towns show that whenever SaveAll has opened a store outside the central shopping district of a small town, within five years the town has experienced the bankruptcies of more than a quarter of the stores in the shopping district. The answer to which of the following would be most useful for evaluating the community activist's reasoning?", "choices": ["Have community activists in other towns successfully campaigned against the opening of a SaveAll store on the outskirts of their towns?", "Do a large percentage of the residents of Morganville currently do almost all of their shopping at stores in Morganville?", "In towns with healthy central shopping districts, what proportion of the stores in those districts suffer bankruptcy during a typical five-year period?", "What proportion of the employees at the SaveAll store on the outskirts of Morganville will be drawn from Morganville?", "Do newly opened SaveAll stores ever lose money during their first five years of operation?"], "hint": "Extremes test: the right question's two answers push the argument opposite ways.", "expl": "Correct answer: C. B is the most chosen wrong answer. Remember one thing: the shop that has the maximum numbers of customers may be the first to go bankrupt (imagine giving away things at 90% discount) … and the shop that has very few customers can be extremely profitable. So, this answer is PLAIN wrong.", "level": "hard", "n": 7},
      {"topic": "Evaluate the argument", "correct": "C", "options": 5, "text": "Between 1976 and 1985, chemical wastes were dumped into Cod Bay. Today, 3 percent of the bay's bluefin cod population have deformed fins, and wary consumers have stopped buying the fish. In seeking financial reparations from companies that dumped the chemicals, representatives of Cod Bay's fishing industry have claimed that since the chemicals are known to cause genetic mutations, the deformity in the bluefin cod must have been caused by the presence of those chemicals in Cod Bay. The answer to each of the following questions would be helpful in evaluating the representatives' claim EXCEPT:", "choices": ["What is the incidence of deformed fins in bluefin cod that are not exposed to chemicals such as those dumped into Cod Bay?", "What was the incidence of deformed fins in bluefin cod in Cod Bay before the chemical dumping began?", "Has the consumption of the bluefin cod from Cod Bay that have deformed fins caused any health problems in the people who ate them?", "Are bluefin cod prone to any naturally occurring diseases that can cause fin deformities of the same kind as those displayed by the bluefin cod of Cod Bay?", "Are there gene-altering pollutants present in Cod Bay other than the chemical wastes that were dumped by the companies?"], "hint": "Extremes test: the right question's two answers push the argument opposite ways.", "expl": "Correct answer: C. The argument opens by presenting two premises: in the past chemical wastes were dumped into Cod Bay, and today 3 percent of the bluefin cod have deformed fins, which has caused consumers to stop buying the cod.", "level": "hard", "n": 8},
      {"topic": "Evaluate the argument", "correct": "C", "options": 5, "text": "A translation invariably reflects the writing style of the translator. Sometimes when a long document needs to be translated quickly, several translators are put to work on the job, each assigned to translate part of the document. In these cases, the result is usually a translation marked by different and often incompatible writing styles. Certain computer programs for language translation that work without the intervention of human translators can finish the job faster than human translators and produce a stylistically uniform translation with an 80 percent accuracy rate. Therefore, when a long document needs to be translated quickly, it is better to use a computer translation program than human translators. Which one of the following issues would be LEAST important to resolve in evaluating the argument?", "choices": ["whether the problem of stylistic variety in human translation could be solved by giving stylistic guidelines to human translators", "whether numerical comparisons of the accuracy of translations can reasonably be made", "whether computer translation programs, like human translators, each have their own distinct writing style", "whether the computer translation contains errors of grammar and usage that drastically alter the meaning of the text", "how the accuracy rate of computer translation programs compares with that of human translators in relation to the users' needs"], "hint": "Extremes test: the right question's two answers push the argument opposite ways.", "expl": "Correct answer: C. The core issue is: Should we use a computer program or human translators to translate a long document? What we know so far is: HUMAN TRANSLATORS - they have different writing styles, which can sometimes be incompatible COMPUTERS - faster than humans - stylistically uniform - 80% accuracy rate The author of this stimulus discusses large translations, which ar", "level": "hard", "n": 9},
      {"topic": "Evaluate the argument", "correct": "D", "options": 5, "text": "Very powerful volcanic eruptions send large amounts of ash high into the atmosphere, blocking sunlight and causing abnormally cold temperatures for a year or more after the eruption. In 44 B.C. there was a powerful eruption of Mount Etna in Sicily. In the following year, Chinese historians recorded summer frosts and dimmed sunlight in China, thousands of miles east of Sicily. If these phenomena were caused by volcanic ash in the atmosphere, then the ash sent into the atmosphere by Mount Etna's eruption must have spread over great distances. In evaluating the support given for the conclusion advanced in the last sentence of the passage, it would be most important to determine whether", "choices": ["modern monitoring equipment can detect the precise path of volcanic ash in the atmosphere", "the abnormal weather in China lasted for a full year or longer", "temperatures in Sicily were abnormally cold after Mount Etna erupted", "there were any volcanic eruptions near China around the time of Mount Etna's eruption", "subsequent eruptions of Mount Etna were as powerful as the one in 44 B.C."], "hint": "Extremes test: the right question's two answers push the argument opposite ways.", "expl": "Correct answer: D. Conclusion: If atmospheric volcanic ash caused China's weird weather in 43 B.C., then Mt. Etna's erupted ash must have spread over great distances Premise: There was weird weather in China the year after Mt. Etna erupted In order to assess assumptions/objections to arguments, we frequently assume the opposite of the conclusion.", "level": "hard", "n": 10},
      {"topic": "Assumption", "correct": "D", "options": 5, "text": "Country B's oil production is not sufficient to meet its domestic demand. In order to sharply reduce its dependence on foreign sources of oil, Country B recently embarked on a program requiring all of its automobiles to run on ethanol in addition to gasoline. Combined with its oil production, Country B produces enough ethanol from agricultural by-products to meet its current demand for energy. Which of the following must be assumed in order to conclude that Country B will succeed in its plan to reduce its dependence on foreign oil?", "choices": ["Electric power is not a superior alternative to ethanol in supplementing automobile gasoline consumption.", "In Country B, domestic production of ethanol is increasing more quickly than domestic oil production.", "Ethanol is suitable for the heating of homes and other applications aside from automobiles.", "In Country B, gasoline consumption is not increasing at a substantially higher rate than domestic oil and ethanol production.", "Ethanol is as efficient as gasoline in terms of mileage per gallon when used as fuel for automobiles."], "hint": "Negation test: negating the correct choice should break the conclusion.", "expl": "Correct answer: D. The argument concludes that the program will sharply reduce Country B's reliance upon foreign oil. It means that the country will not have to import. The only condition that a country doesn't need to import is: Production ≥ Consumption Production alone or consumption alone can't decide the import.", "level": "hard", "n": 11},
      {"topic": "Assumption", "correct": "A", "options": 5, "text": "Although there has been great scientific debate for decades over global warming, most scientists now agree that human activity is causing the Earth's temperature to rise. Though predictions vary, many global warming experts believe that average global temperatures will rise between three- and eight-degrees Fahrenheit during the next century. Such an increase would cause an alarming rise in sea levels, displacing millions of people by destroying major population centers along the world's coastlines. Which of the following is an assumption in support of the argument's conclusion?", "choices": ["New technological developments in the next century will not divert rising seas from the world's coastal cities.", "Individuals will not become more aware of the steps they can take to reduce the emission of greenhouse gases.", "Rising sea levels similarly affect all coastal population centers.", "Some global warming experts predict a greater than eight-degree Fahrenheit increase in global temperatures during the next century.", "Human activity is the sole cause of increasing global temperatures."], "hint": "Negation test: negating the correct choice should break the conclusion.", "expl": "Correct answer: A. The argument concludes that rising sea levels caused by global warming will destroy major coastal population centers and displace millions of people. Any assumption in support of this conclusion would have to corroborate that these events will definitively take place.", "level": "hard", "n": 12},
      {"topic": "Assumption", "correct": "C", "options": 5, "text": "In response to the increasing cost of producing energy through traditional means, such as combustion, many utility companies have begun investing in renewable energy sources, chiefly wind and solar power, hoping someday to rely on them completely and thus lower energy costs. These sources require significant initial capital investment, but the operating costs are not so high; so, the utility companies claim that they will be able to provide stable energy supplies to all their clients. As one can easily see, these sources will be less risky for the utilities than non- renewable sources, such as gas, oil, and coal, whose prices can fluctuate dramatically according to availability. The claim of the utility companies assumes which of the following?", "choices": ["The public will embrace the development of wind and solar power.", "No new deposits of gas, oil, and coal will be discovered in the near future.", "Weather patterns are consistent and predictable.", "The necessary technology for conversion to wind and solar power is not more expensive than the technology needed to create energy through combustion.", "Obtaining energy from non-renewable sources, such as gas, oil and coal, cannot be made less risky."], "hint": "Negation test: negating the correct choice should break the conclusion.", "expl": "Correct answer: C. The claim of the companies is that the renewable sources will provide stable supplies of energy to all its customers. We are asked to find an assumption underlying this argument. In order for this argument to be valid, it must in fact be true that these renewable sources of energy will provide stable supplies. (C) CORRECT.", "level": "hard", "n": 13},
      {"topic": "Assumption", "correct": "A", "options": 5, "text": "In 1992 outlaw fishing boats began illegally harvesting lobsters from the territorial waters of the country of Belukia. Soon after, the annual tonnage of lobster legally harvested in Belukian waters began declining; in 1996, despite there being no reduction in the level of legal lobster fishing activity, the local catch was 9,000 tons below pre-1992 levels. It is therefore highly likely that the outlaw fishing boats harvested about 9,000 tons of lobster illegally that year. Which of the following is an assumption on which the argument depends?", "choices": ["Compared to 1992 levels, the population of catchable lobsters in Belukia's territorial waters had not sharply declined by 1996.", "The average annual lobster catch, in tons, of an outlaw fishing boat has increased steadily since 1992.", "Outlaw fishing boats do not, as a group, harvest more lobsters than do licensed lobster-fishing boats.", "The annual legal lobster harvest in Belukia in 1996 was not significantly less than 9,000 tons.", "A significant proportion of Belukia's operators of licensed lobster-fishing boats went out of business between 1992 and 1996."], "hint": "Negation test: negating the correct choice should break the conclusion.", "expl": "Correct answer: A. Let's assume that before 1992 there were 100,000 catchable lobsters in the sea. Of 100,000 catchable lobsters, let's assume all 100,000 were legally harvested. In 1996, we know that the number of legally harvested lobsters were 91,000.", "level": "hard", "n": 14},
      {"topic": "Assumption", "correct": "A", "options": 5, "text": "Agricultural societies cannot exist without staple crops. Several food plants, such as kola and okra, are known to have been domesticated in western Africa, but they are all supplemental, not staple, foods. All the recorded staple crops grown in western Africa were introduced from elsewhere, beginning, at some unknown date, with rice and yams. Therefore, discovering when rice and yams were introduced into western Africa would establish the earliest date at which agricultural societies could have arisen there. Which of the following is an assumption on which the argument depends?", "choices": ["People in western Africa did not develop staple crops that they stopped cultivating once rice and yams were introduced.", "There are no plants native to western Africa that, if domesticated, could serve as staple food crops.", "Rice and yams were grown as staple crops by the earliest agricultural societies outside of western Africa.", "Kola and okra are better suited to growing conditions in western Africa than domesticated rice and yams are.", "Kola and okra were domesticated in western Africa before rice and yams were introduced there."], "hint": "Negation test: negating the correct choice should break the conclusion.", "expl": "Correct answer: A. Conclusion: if we can come to know the precise date when Rice and Yam cultivation started, we will come to know the precise date exactly when the agricultural society started … as it is given that agricultural societies can't exist without staple crops. So, in a way, the author has to assume that there was / were no other staple crop(s) before Rice and Yam.", "level": "hard", "n": 15},
      {"topic": "Assumption", "correct": "D", "options": 5, "text": "Doctor: Research shows that adolescents who play video games on a regular basis are three times as likely to develop carpal tunnel syndrome as are adolescents who do not play video games. Federal legislation that prohibits the sale of video games to minors would help curb this painful wrist condition among adolescents. The doctor's conclusion depends on which of the following assumptions?", "choices": ["The majority of federal legislators would vote for a bill that prohibits the sale of video games to minors.", "Not all adolescents who play video games on a regular basis suffer from carpal tunnel syndrome.", "Playing video games is the only way an adolescent can develop carpal tunnel syndrome.", "Most parents would refuse to purchase video games for their adolescent children.", "The regular playing of video games by adolescents does not produce such beneficial effects as better hand-eye coordination and improved reaction time."], "hint": "Negation test: negating the correct choice should break the conclusion.", "expl": "Correct answer: D. The doctor concludes that federal legislation prohibiting the sale of video games to minors would help reduce the incidence of carpal tunnel syndrome. This conclusion hinges on the assumption that the only way for adolescents to access video games is to purchase the games themselves.", "level": "hard", "n": 16},
      {"topic": "Assumption", "correct": "E", "options": 5, "text": "Researchers studying the spread of the Black Plague in sixteenth-century England claim that certain people survived the epidemic because they carried a genetic mutation, known as Delta-32, that is known to prevent the bacteria that causes the Plague from overtaking the immune system. To support this hypothesis, the researchers tested the direct descendants of the residents of an English town where an unusually large proportion of people survived the Plague. More than half of these descendants tested positive for the mutation Delta-32, a figure nearly three times higher than that found in other locations. The researchers' hypothesis is based on which of the following assumptions?", "choices": ["Delta-32 does not prevent a carrier from contracting any disease other than the Plague.", "The Plague is not similar to other diseases caused by bacteria.", "Delta-32 did not exist in its current form until the sixteenth century.", "No one who tested positive for Delta-32 has ever contracted a disease caused by bacteria.", "The Plague does not cause genetic mutations such as Delta-32."], "hint": "Negation test: negating the correct choice should break the conclusion.", "expl": "Correct answer: E. Conclusion: A causes B Assumption: B doesn't cause A … direct answer E The researchers claim that Delta-32 prevents its carriers from contracting the Plague. They support this claim by noting that a strikingly large percentage of descendants of Plague survivors carry the mutation. We are asked to find an assumption underlying the claim.", "level": "hard", "n": 17},
      {"topic": "Assumption", "correct": "A", "options": 5, "text": "If the appropriate timely surgery is not performed on someone who has suffered from appendicitis, the outcome can be potentially fatal; consequently, patients with symptoms strongly suggesting appendicitis are almost always made to undergo a surgery, whether they have actually had appendicitis or not. The appropriate surgery is extremely low-risk but is performed unnecessarily in about 20 percent of all cases. A newly developed internal scan to determine whether someone with symptoms of appendicitis has actually had appendicitis produces absolutely correct diagnosis in 98% of the cases. Clearly, using this scan, doctors can largely avoid unnecessary surgeries related to appendicitis, without, however, performing any fewer necessary surgeries. Which of the following assumption is required for the conclusion to be always true?", "choices": ["the misdiagnoses produced by this scan are always instances of attributing appendicitis to someone who has not had it", "the misdiagnoses produced by this scan are never instances of attributing appendicitis to someone who has not had it", "all of the patients who are diagnosed with this scan as having had appendicitis have actually had appendicitis", "every patient who is diagnosed with this scan as having had appendicitis always has more than one of the symptoms associated with appendicitis", "the only patients who are misdiagnosed using this scan are patients who lack one or more of the symptoms that are generally associated with appendicitis"], "hint": "Negation test: negating the correct choice should break the conclusion.", "expl": "Correct answer: A.", "level": "hard", "n": 18},
      {"topic": "Assumption", "correct": "D", "options": 5, "text": "Until now, only injectable vaccines against influenza have been available. Parents are reluctant to subject children to the pain of injections, but adults, who are at risk of serious complications from influenza, are commonly vaccinated. A new influenza vaccine, administered painlessly in a nasal spray, is effective for children. However, since children seldom develop serious complications from influenza, no significant public health benefit would result from widespread vaccination of children using the nasal spray. Which of the following is an assumption on which the argument depends?", "choices": ["Any person who has received the injectable vaccine can safely receive the nasal- spray vaccine as well.", "The new vaccine uses the same mechanism to ward off influenza as injectable vaccines do.", "The injectable vaccine is affordable for all adults.", "Adults do not contract influenza primarily from children who have influenza.", "The nasal spray vaccine is not effective when administered to adults."], "hint": "Negation test: negating the correct choice should break the conclusion.", "expl": "Correct answer: D. D", "level": "hard", "n": 19},
      {"topic": "Assumption", "correct": "E", "options": 5, "text": "To decrease the number of crimes in city Y, the city's Police Commissioner proposed taking some police officers from low-crime districts of the city and moving them to high-crime districts of the city. His proposal is based on city Y crime data that show that the number of crimes in any district of the city decreases when additional police officers are moved into that district. The Police Commissioner's proposal depends on which of the following assumptions?", "choices": ["City X experienced a drastic reduction in crime after implementing a proposal similar to that proposed by the Police Commissioner of city Y.", "The severity of crimes committed in any district of the city decreases when additional police officers are moved into that district.", "The number of crimes committed in all high-crime districts of city Y is more than triple the number of crimes committed in all low-crime districts of city Y.", "There are more low-crime districts than high-crime districts in city Y.", "Districts of the city from which police officers are removed do not experience significant crime increases shortly after the removal of those officers."], "hint": "Negation test: negating the correct choice should break the conclusion.", "expl": "Correct answer: E. E The Police Commissioner's proposal hopes to decrease the number of crimes in city Y by shifting police officers from low-crime to high-crime districts. His proposal is based on data that demonstrate that crime decreases when additional police officers are moved into a district.", "level": "hard", "n": 20},
      {"topic": "Assumption", "correct": "A", "options": 5, "text": "The Earth's rivers constantly carry dissolved salts into its oceans. Clearly, therefore, by taking the resulting increase in salt levels in the oceans over the past hundred years and then determining how many centuries of such increases it would have taken the oceans to reach current salt levels from a hypothetical initial salt-free state, the maximum age of the Earth's oceans can be accurately estimated. Which of the following is an assumption on which the argument depends?", "choices": ["The quantities of dissolved salts deposited by rivers in the Earth's oceans have not been unusually large during the past hundred years.", "At any given time, all the Earth's rivers have about the same salt levels.", "There are salts that leach into the Earth's oceans directly from the ocean floor.", "There is no method superior to that based on salt levels for estimating the maximum age of the Earth's oceans.", "None of the salts carried into the Earth's oceans by rivers are used up by biological activity in the oceans."], "hint": "Negation test: negating the correct choice should break the conclusion.", "expl": "Correct answer: A. A Between A and E ... negate the assumption and the argument should fall apart. Negate E Some of the salts carried into the Earth's oceans by rivers are used up by biological activity in the oceans. But if the portion of salt consumed by biological activities has remained constant over the years ... we can still predict the age of the oceans ...", "level": "hard", "n": 21},
      {"topic": "Assumption", "correct": "C", "options": 5, "text": "Two centuries ago, Tufe Peninsula became separated from the mainland, isolating on the newly formed Tufe Island a population of Turfil sunflowers. This population's descendants grow to be, on average, 40 centimeters shorter than Turfil sunflowers found on the mainland. Tufe Island is significantly drier than Tufe Peninsula was. So, the current average height of Tufe's Turfil sunflowers is undoubtedly at least partially attributable to changes in Tufe's environmental conditions. Which of the following is an assumption on which the argument depends?", "choices": ["There are no types of vegetation on Tufe Island that are known to benefit from dry conditions.", "There were about as many Turfil sunflowers on Tufe Peninsula two centuries ago as there are on Tufe Island today.", "The mainland's environment has not changed in ways that have resulted in Turfil sunflowers on the mainland growing to be 40 centimeters taller than they did two centuries ago.", "The soil on Tufe Island, unlike that on the mainland, lacks important nutrients that help Turfil sunflowers survive and grow tall in a dry environment.", "The 40-centimeter height difference between the Turfil sunflowers on Tufe Island and those on the mainland is the only difference between the two populations."], "hint": "Negation test: negating the correct choice should break the conclusion.", "expl": "Correct answer: C. C Conclusion- the current average height of Tufe's Turfil sunflowers is undoubtedly at least partially attributable to changes in Tufe's environmental conditions This means that the changes in the newly formed island's climate caused the sunflower plants to get shorter.", "level": "hard", "n": 22},
      {"topic": "Assumption", "correct": "E", "options": 5, "text": "The spacing of the four holes on a fragment of a bone flute excavated at a Neanderthal campsite is just what is required to play the third through sixth notes of the diatonic scale-the seven-note musical scale used in much of Western music since the Renaissance. Musicologists therefore hypothesize that the diatonic musical scale was developed and used thousands of years before it was adopted by Western musicians. Which of the following is an assumption required by the argument above?", "choices": ["Bone flutes were probably the only musical instrument made by Neanderthals.", "No musical instrument that is known to have used a diatonic scale is of an earlier date than the flute found at the Neanderthal campsite.", "The flute was made from a cave-bear bone and the campsite at which the flute fragment was excavated was in a cave that also contained skeletal remains of cave bears.", "Flutes are the simplest wind instrument that can be constructed to allow playing a diatonic scale.", "The bone used to make the Neanderthal flute would have been long enough to make a flute capable of playing a complete diatonic scale."], "hint": "Negation test: negating the correct choice should break the conclusion.", "expl": "Correct answer: E. We can summarize the argument as follows: Flute fragment found with 4 notes of the diatonic scale. Therefore, creators of flute knew about and used the diatonic scale. In order to reach that conclusion, the author has to assume that the 4 notes on the fragment aren't just coincidentally on the diatonic scale.", "level": "hard", "n": 23},
      {"topic": "Assumption", "correct": "B", "options": 5, "text": "Student Advisor: One of our exchange students faced multiple arguments with her parents over the course of the past year. Not surprisingly, her grade point average (GPA) over the same period showed a steep decline. This is just one example of a general truth: problematic family relationships can cause significant academic difficulties for our students. Which of the following is required for the Student Advisor to claim that problematic family relationships can cause academic difficulties?", "choices": ["Last year, the exchange student reduced the amount of time spent on academic work, resulting in a lower GPA.", "The decline in the GPA of the exchange student was not the reason for the student's arguments with her parents.", "School GPA is an accurate measure of a student's intellectual ability.", "If proper measures are not taken, the decline in the student's academic performance may become irreversible.", "Fluctuations in academic performance are typical for many students."], "hint": "Negation test: negating the correct choice should break the conclusion.", "expl": "Correct answer: B. Conclusion: A caused B Assumption: B didn't cause A Two things happened:", "level": "hard", "n": 24},
      {"topic": "Assumption", "correct": "B", "options": 5, "text": "Science writer: All scientists have beliefs and values that might slant their interpretations of the data from which they draw their conclusions. However, serious scientific papers are carefully reviewed by many other scientists before publication. These reviewers are likely to notice and object to biases that they do not share. Thus, any slanted interpretations of scientific data will generally have been removed before publication. Which one of the following is an assumption required by the science writer's argument?", "choices": ["The scientists reviewing serious scientific papers for publication do not always have biases likely to slant their interpretations of the data in those papers.", "In general, biases that slant interpretations of data in serious scientific papers being reviewed for publication are not shared among all scientists.", "Biases that are present in published scientific papers and shared by most scientists, including those who review the papers, are unlikely to impair the scientific value of those papers.", "The interpretation of data is the only part of a serious scientific paper that is sometimes slanted by the beliefs and values of scientists.", "Slanted interpretations of data in a scientific paper can be removed only through careful review by scientists who do not share the biases of the author or authors of the paper."], "hint": "Negation test: negating the correct choice should break the conclusion.", "expl": "Correct answer: B. B (A) says that the reviewers do not always have biases likely to slant their interpretations of the data in those papers. Let's negate (A) and say that reviewers do always have biases likely to slant their interpretations of the data. Does this negated answer destroy the argument? Not necessarily.", "level": "hard", "n": 25}
    ]
  }
];
