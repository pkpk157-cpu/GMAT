...
step 3 "notation"                  node "$d/../notation.js"
step 3 "explanation render"        node "$d/expl-render.js"
step 3 "notation render"           node "$d/notation-render.js"
step 3 "concept guides"            node "$d/../concepts.js"
step 3 "syllabus coverage"         node "$d/../syllabus.js"
step 3 "concept render"            node "$d/concept-render.js"
...
step 3 "sw update timing"          node "$d/sw-reload.js"
step 3 "reading timer"             node "$d/read-timer.js"
